...
| 4 表单进阶 | 完成 | More options、计算说明、校验、无餐厅拦截、跨午夜 | 默认表单仍短，复杂规则可展开 |
| 5 Stats / Me / 备份 | 完成 | 周月统计、餐厅设置、偏好、CSV/JSON、隐私 | 看趋势、改设置、带走数据 |
| 6 真机发布 | 完成 | 真机走查、无障碍抽查、EAS、隐私权限 | iOS V1 商店候选 |
...
- [阶段 5 Stats / Me / 备份](./2026-08-24-phase-5-stats-me-backup.md)
- [阶段 6 真机发布](./2026-08-24-phase-6-device-release.md)
